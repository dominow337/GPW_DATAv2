...
public class Circle : MonoBehaviour {
    ...
    void Start()
    {
            ...
            if (l == 0)
                {
                    pos = transform.position + new Vector3((PC1*20000f), (PC2*200f), (PC3*20000f));
                }
                else if (l % 2 == 0 && l % 3 != 0)
                {
                    pos = transform.position + new Vector3((PC1 * 20000f * x), (PC2*200f), (PC3*20000f));
                }
                else if (l % 3 == 0)
                {
                    pos = transform.position + new Vector3((PC1*20000f), (PC2*200f * y), (PC3*20000f));
                }
                else
                {
                    pos = transform.position + new Vector3((PC1*20000f), (PC2*200f), (PC3*20000f * z));
                }
                ...
                MyGrey.material.color = new Color(grey/10, grey/10, grey/10, 0.4f);
